    ...
    <nav class="navbar  navbar-expand-lg navbar-dark bg-info px-5">
        ...
        <div class="collapse navbar-collapse" id="navbar_nav">
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a href="" class="nav-link text-white"><i class="me-1 fas fa-user"></i>Welcome Mark Johnson</a>
                </li>
               
                <li class="nav-item">
                    <a  href="" class="nav-link text-white"><i class="me-1 fas fa-user"></i>Logout</a>
                </li>
            </ul>
        </div>
